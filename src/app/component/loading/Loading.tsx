...
export default function Loading() {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black backdrop-blur-sm">
      <motion.div
        initial={{ opacity: 0, scale: 0.8 }}
        animate={{ opacity: 1, scale: 1 }}
        exit={{ opacity: 0, scale: 0.8 }}
        transition={{ duration: 0.5, type: "spring", stiffness: 100 }}
        className="relative w-80 flex flex-col items-center justify-center p-8 border border-zinc-950 rounded-lg bg-zinc-900/80 shadow-2xl"
      >
        <svg
          id="svg-global"
        ...
        <p className="mt-6 text-lg font-semibold text-zinc-300">
         {lang === 'fa' ? '...درحال بارگذاری' : 'on processing'} 
        </p>
        <p className="mt-2 text-sm text-zinc-400 max-w-xs text-center">
