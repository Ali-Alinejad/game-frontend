...
export const translations: Translations = {
  en: {
    ...
    enterGameFordNow: "Enter enterGameFord Now",
  ...
  fa: {
    ...
    enterGameFordNow: "ورود به گیم فورد اکنون",
