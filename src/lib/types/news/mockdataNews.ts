...
export const NewsArticleMock = [
  {
    ...
    views: 55000,
    title: {
      en: "The Future of Xbox: Exclusivity or Multiplatform?",
      fa: "آینده ایکس‌باکس: انحصاری یا چندپلتفرمی؟",
    },
    excerpt: {
      en: "Discussing Microsoft strategy.",
      fa: "بحث در مورد استراتژی مایکروسافت.",
    },
    content: {
      en: "Mock content for related article 1.",
      fa: "محتوای ساختگی برای مقاله مرتبط ۱.",
    },
    author: {
      name: "Ali Karimi",
      title: "Tech Reviewer",
      bio: "Expert in console hardware.",
      avatar: "K",
    },
    tags: ["Xbox", "Microsoft"],
  },
  {
    ...
    views: 23000,
    title: {
      en: "10 Must-Play Indie Games of Late 2025",
      fa: "۱۰ بازی مستقل که باید در اواخر ۲۰۲۵ بازی کنید",
    },
    excerpt: {
      en: "Hidden gems for every platform.",
      fa: "جواهرات پنهان برای هر پلتفرم.",
    },
    content: {
      en: "Mock content for related article 2.",
      fa: "محتوای ساختگی برای مقاله مرتبط ۲.",
    },
    author: {
      name: "Sara Saffari",
      title: "Indie Curator",
      bio: "Loves small games with big hearts.",
      avatar: "",
    },
    tags: ["Indie", "Review"],
  },
  {
    ...
    views: 78000,
    title: {
      en: "Major Esports League Faces Match Fixing Controversy",
      fa: "لیگ بزرگ ورزش‌های الکترونیکی با جنجال تبانی روبرو شد",
    },
    excerpt: { en: "The investigation details.", fa: "جزئیات تحقیقات." },
    content: {
      en: "Mock content for related article 3.",
      fa: "محتوای ساختگی برای مقاله مرتبط ۳.",
    },
    author: {
      name: "Mohsen Nouri",
      title: "Esports Analyst",
      bio: "Tracks competitive gaming globally.",
      avatar: "",
    },
