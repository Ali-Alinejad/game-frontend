    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className={cn(
                    "group flex items-center gap-2 py-1 px-3 scale-90 max-sm:mt-3 max-sm:scale-75 ",
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className={cn(
                            "absolute   max-sm:scale-75 w-32 rounded-3xl overflow-hidden z-!500",
                    ...
                    >
                        {languages.map((language, index) => (
                            <motion.button
                                ...
                                className={cn(
                                    "group/item flex items-center gap-3 w-full px-2 py-1.5 text-sm font-medium",
